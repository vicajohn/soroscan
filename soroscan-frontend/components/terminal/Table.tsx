...
>(({ className, ...props }, ref) => (
  <div className="relative w-full overflow-auto border-terminal border-terminal-green">
    {/* Subtle grid lines background overlay etc could be added here */}
    <table
      ref={ref}
      className={cn("w-full caption-bottom text-sm font-terminal-mono", className)}
      {...props}
    />
  </div>
))
...
>(({ className, ...props }, ref) => (
  <tfoot
    ref={ref}
    className={cn(
      "border-t border-terminal-green bg-terminal-green/5 font-medium",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <tr
    ref={ref}
    className={cn(
      "border-b border-terminal-green/30 transition-colors hover:bg-terminal-green/10 hover:shadow-glow-green/20 group cursor-default",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <td
    ref={ref}
    className={cn(
      "p-4 align-middle [&:has([role=checkbox])]:pr-0 group-hover:text-terminal-green transition-colors",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <caption
    ref={ref}
    className={cn("mt-4 text-xs text-terminal-gray font-terminal-mono italic", className)}
    {...props}
  />
))
